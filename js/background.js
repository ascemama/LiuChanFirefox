		...
		switch (request.type) {
			...
			case 'tts':
				...
				chrome.tts.speak(request.text, {
					"lang": liuChan.config.ttsDialect,
			...
			case 'notepad':
				...
				break;
			case 'updateContextMenuAddCharacter':
				VocabList.updateContextMenuAddCharacter(request.entry);
				response();
				break;
			case 'loadVocabList':
			...
			case 'storeVocabList':
				return new Promise(resolve => {
					...
					VocabList.storeVocabList(request.content)
					return resolve();
				})
				break;
			case 'removeShowVocabListFromContextMenu':
				VocabList.updateContextMenuRemoveShowVocabList();
				break;
			case 'addShowVocabListFromContextMenu':
